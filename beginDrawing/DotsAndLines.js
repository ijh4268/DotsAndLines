...
// first, create an array with all our vertex attribute values:
  var vertices = new Float32Array([
     -0.2, -0.2, -0.2, 1.0,	// CAREFUL! I made these into 4D points/ vertices: x,y,z,w.
      0.3, -0.2, -0.2, 1.0,	// new point!  (? What happens if I make w=0 instead of 1.0?)
     -0.2,  0.3, -0.2, 1.0,   
     -0.2, -0.2,  0.3, 1.0, // new point!   
  ]);
